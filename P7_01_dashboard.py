...
def user_input_features():
    ...
    DAYS_EMPLOYED = st.sidebar.slider('DAYS_EMPLOYED', -12203.00, -100.00, float(-6000.00))
    AMT_REQ_CREDIT_BUREAU_YEAR = st.sidebar.slider('AMT_REQ_CREDIT_BUREAU_YEAR', 0.00, 8.00, float(4.00))
    OWN_CAR_AGE = st.sidebar.slider('OWN_CAR_AGE', 1.00, 30.00, float(15.00))
    OBS_60_CNT_SOCIAL_CIRCLE = st.sidebar.slider('OBS_60_CNT_SOCIAL_CIRCLE', 0.00, 10.00, float(5.00))
    OBS_30_CNT_SOCIAL_CIRCLE = st.sidebar.slider('OBS_30_CNT_SOCIAL_CIRCLE', 0.00, 10.00, float(5.00))
    AMT_ANNUITY = st.sidebar.slider('AMT_ANNUITY', 6750.00, 67500.00, float(30000.00))
    DAYS_REGISTRATION = st.sidebar.slider('DAYS_REGISTRATION', -14166.00, -51.00, float(-7000.00))
    DAYS_LAST_PHONE_CHANGE = st.sidebar.slider('DAYS_LAST_PHONE_CHANGE', -2800.00, 0.00, float(-1400.00))
