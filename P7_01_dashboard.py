...
def user_input_features():
    EXT_SOURCE_3 = st.sidebar.slider('EXT_SOURCE_3', float(0.03), float(0.83), float(0.40))
    EXT_SOURCE_2 = st.sidebar.slider('EXT_SOURCE_2', float(0.03), float(0.83), float(0.40))
    DAYS_EMPLOYED = st.sidebar.slider('DAYS_EMPLOYED', float(-12203.00), float(-100), float(-6000))
    AMT_REQ_CREDIT_BUREAU_YEAR = st.sidebar.slider('AMT_REQ_CREDIT_BUREAU_YEAR', float(0), float(8), float(4))
    OWN_CAR_AGE = st.sidebar.slider('OWN_CAR_AGE', float(1), float(30), float(15))
    OBS_60_CNT_SOCIAL_CIRCLE = st.sidebar.slider('OBS_60_CNT_SOCIAL_CIRCLE', float(0), float(10), float(5))
    OBS_30_CNT_SOCIAL_CIRCLE = st.sidebar.slider('OBS_30_CNT_SOCIAL_CIRCLE', float(0), float(10), float(5))
    AMT_ANNUITY = st.sidebar.slider('AMT_ANNUITY', float(6750.00), float(67500.00), float(30000))
    DAYS_REGISTRATION = st.sidebar.slider('DAYS_REGISTRATION', float(-14166.00), float(-51), float(-7000))
    DAYS_LAST_PHONE_CHANGE = st.sidebar.slider('DAYS_LAST_PHONE_CHANGE', float(-2800), float(0), float(-1400))
    EXT_SOURCE_1 = st.sidebar.slider('EXT_SOURCE_1',float(0.06), float(0.88), float(0.44))
    REGION_POPULATION_RELATIVE = st.sidebar.slider('REGION_POPULATION_RELATIVE', float(0.00), float(0.07), float(0.04))
